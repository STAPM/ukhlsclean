...
- __grss_earnings_usual__ (numeric) nominal gross earnings per month from employment (usual pay) plus self-employment

- __grss_earnings_last__ (numeric) nominal gross earnings per month from employment (last received payment) plus self-employment

- __real_grss_earnings_usual__ (numeric) real gross earnings per month from employment (usual pay) plus self-employment

- __real_grss_earnings_last__ (numeric) real gross earnings per month from employment (last received payment) plus self-employment
