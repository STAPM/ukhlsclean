...
Data checks are conducted on a pooled sample of all calendar-year datasets of the UKHLS from 2020 onwards, currently including 2020 only. Most checks make use of the most recently available data release, currently 2020. The plots below make use of the survey weights in the data, and so are adjusted for survey design and non-response. Totals are further adjusted using a scaling factor to gross the totals up to the full UK population aged 16-89.    
