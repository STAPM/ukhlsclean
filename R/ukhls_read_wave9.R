...
ukhls_read_wave9 <- function(
  ...
  cat(crayon::magenta("\tReading UKHLS Wave 9"))
  ...
  data <- data.table::fread(
    paste0(path, "/ukhls_w9/i_indresp.tab"),
    showProgress = FALSE,
  ...
  demographic_vars <- Hmisc::Cs(i_sex,i_dvage,i_birthy,i_gor_dv,i_urban_dv,i_mlstat)
  ...
  weight_vars      <- Hmisc::Cs(i_indinus_lw,i_indinub_xw)
  ...
  data.hhold <- data.table::fread(
    paste0(path, "/ukhls_w9/i_hhresp.tab"),
    showProgress = FALSE,
