#' Read British Household Panel Survey Wave 9
#'
#' Reads and does basic cleaning on the BHPS 9th wave.
#'
#' MISSING VALUES
#'
#' \itemize{
...
#' }
#' @export
bhps_read_wave9 <- function(
  root = c("C:/"),
  path = "Users/User/Documents/Datasets/UKHLS/tab/"
) {

  print("Reading BHPS Wave 9")
  data <- data.table::fread(
    paste0(root[1], path, "bhps_w9/bi_indresp.tab"),
  ...
  demographic_vars <- colnames(data[ , c(33,1024,32,1225,119)])
  econ_stat_vars   <- colnames(data[,c(34)])
  weight_vars      <- colnames(data[,c(1149,1147)])
  ...
  data.table::setnames(data,
                       c("pid","bi_hidp","bi_pno",
                         ## demographic
                         "bi_sex","bi_age_dv","bi_doby","bi_gor_dv","bi_race",
                         ## economic stauts
                         "bi_jbstat",
                         ## weight
                         "bi_xrwght","bi_lrwght"),
