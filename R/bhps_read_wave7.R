#' Read British Household Panel Survey Wave 7
#'
#' Reads and does basic cleaning on the BHPS 7th wave.
#'
#' MISSING VALUES
#'
#' \itemize{
...
#' }
#' @export
bhps_read_wave7 <- function(
  root = c("C:/"),
  path = "Users/User/Documents/Datasets/UKHLS/tab/"
) {

  print("Reading BHPS Wave 7")
  data <- data.table::fread(
    paste0(root[1], path, "bhps_w7/bg_indresp.tab"),
  ...
  demographic_vars <- colnames(data[ , c(32,792,31,926,80)])
  econ_stat_vars   <- colnames(data[,c(33)])
  weight_vars      <- colnames(data[,c(875,873)])
  ...
  data.table::setnames(data,
                       c("pid","bg_hidp","bg_pno",
                         ## demographic
                         "bg_sex","bg_age_dv","bg_doby","bg_gor_dv","bg_race",
                         ## economic stauts
                         "bg_jbstat",
                         ## weight
                         "bg_xrwght","bg_lrwght"),
