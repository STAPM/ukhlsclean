...
ukhls_read_wave4 <- function(
  ...
  cat(crayon::magenta("\tReading UKHLS Wave 4"))
  ...
  data <- data.table::fread(
    paste0(path, "/ukhls_w4/d_indresp.tab"),
    showProgress = FALSE,
  ...
  demographic_vars <- Hmisc::Cs(d_sex,d_dvage,d_birthy,d_gor_dv,d_urban_dv,d_mlstat)
  ...
  data.hhold <- data.table::fread(
    paste0(path, "/ukhls_w4/d_hhresp.tab"),
    showProgress = FALSE,
