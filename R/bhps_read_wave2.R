#' Read British Household Panel Survey Wave 2
#'
#' Reads and does basic cleaning on the BHPS 2nd wave.
#'
#' MISSING VALUES
#'
#' \itemize{
...
#' }
#' @export
bhps_read_wave2 <- function(
  root = c("C:/"),
  path = "Users/User/Documents/Datasets/UKHLS/tab/"
) {

  print("Reading BHPS Wave 2")
  data <- data.table::fread(
    paste0(root[1], path, "bhps_w2/bb_indresp.tab"),
  ...
  demographic_vars <- colnames(data[ , c(29,685,28,837,73)])
  econ_stat_vars   <- colnames(data[,c(30)])
  weight_vars      <- colnames(data[,c(766,764)])
  ...
  data.table::setnames(data,
                       c("pid","bb_hidp","bb_pno",
                         ## demographic
                         "bb_sex","bb_age_dv","bb_doby","bb_gor_dv","bb_race",
                         ## economic stauts
                         "bb_jbstat",
                         ## weight
                         "bb_xrwght","bb_lrwght"),
