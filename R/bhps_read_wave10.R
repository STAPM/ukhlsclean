#' Read British Household Panel Survey Wave 10
#'
#' Reads and does basic cleaning on the BHPS 10th wave.
#'
#' MISSING VALUES
#'
#' \itemize{
...
#' }
#' @export
bhps_read_wave10 <- function(
  root = c("C:/"),
  path = "Users/User/Documents/Datasets/UKHLS/tab/"
) {

  print("Reading BHPS Wave 10")
  data <- data.table::fread(
    paste0(root[1], path, "bhps_w10/bj_indresp.tab"),
  ...
  demographic_vars <- colnames(data[ , c(33,1001,32,1195,119)])
  econ_stat_vars   <- colnames(data[,c(34)])
  weight_vars      <- colnames(data[,c(1115,1113)])
  ...
  data.table::setnames(data,
                       c("pid","bj_hidp","bj_pno",
                         ## demographic
                         "bj_sex","bj_age_dv","bj_doby","bj_gor_dv","bj_race",
                         ## economic stauts
                         "bj_jbstat",
                         ## weight
                         "bj_xrwght","bj_lrwght"),
