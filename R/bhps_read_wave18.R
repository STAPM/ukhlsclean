#' Read British Household Panel Survey Wave 18
#'
#' Reads and does basic cleaning on the BHPS 18th wave.
#'
#' MISSING VALUES
#'
#' \itemize{
...
#' }
#' @export
bhps_read_wave18 <- function(
  root = c("C:/"),
  path = "Users/User/Documents/Datasets/UKHLS/tab/"
) {

  print("Reading BHPS Wave 18")
  data <- data.table::fread(
    paste0(root[1], path, "bhps_w18/br_indresp.tab"),
  ...
  demographic_vars <- colnames(data[ , c(33,1110,32,1283,91)])
  econ_stat_vars   <- colnames(data[,c(38)])
  weight_vars      <- colnames(data[,c(1192,1190)])
  ...
  data.table::setnames(data,
                       c("pid","br_hidp","br_pno",
                         ## demographic
                         "br_sex","br_age_dv","br_doby","br_gor_dv","br_racel_bh",
                         ## economic stauts
                         "br_jbstat",
                         ## weight
                         "br_xrwght","br_lrwght"),
