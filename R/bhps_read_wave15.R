#' Read British Household Panel Survey Wave 15
#'
#' Reads and does basic cleaning on the BHPS 15th wave.
#'
#' MISSING VALUES
#'
#' \itemize{
...
#' }
#' @export
bhps_read_wave15 <- function(
  root = c("C:/"),
  path = "Users/User/Documents/Datasets/UKHLS/tab/"
) {

  print("Reading BHPS Wave 15")
  data <- data.table::fread(
    paste0(root[1], path, "bhps_w15/bo_indresp.tab"),
  ...
  demographic_vars <- colnames(data[ , c(33,1039,32,1206,91)])
  econ_stat_vars   <- colnames(data[,c(38)])
  weight_vars      <- colnames(data[,c(1123,1121)])
  ...
  data.table::setnames(data,
                       c("pid","bo_hidp","bo_pno",
                         ## demographic
                         "bo_sex","bo_age_dv","bo_doby","bo_gor_dv","bo_racel_bh",
                         ## economic stauts
                         "bo_jbstat",
                         ## weight
                         "bo_xrwght","bo_lrwght"),
