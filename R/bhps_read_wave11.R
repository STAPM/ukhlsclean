#' Read British Household Panel Survey Wave 11
#'
#' Reads and does basic cleaning on the BHPS 11th wave.
#'
#' MISSING VALUES
#'
#' \itemize{
...
#' }
#' @export
bhps_read_wave11 <- function(
  root = c("C:/"),
  path = "Users/User/Documents/Datasets/UKHLS/tab/"
) {

  print("Reading BHPS Wave 11")
  data <- data.table::fread(
    paste0(root[1], path, "bhps_w11/bk_indresp.tab"),
  ...
  demographic_vars <- colnames(data[ , c(33,1156,32,1353,119)])
  econ_stat_vars   <- colnames(data[,c(38)])
  weight_vars      <- colnames(data[,c(1272,1270)])
  ...
  data.table::setnames(data,
                       c("pid","bk_hidp","bk_pno",
                         ## demographic
                         "bk_sex","bk_age_dv","bk_doby","bk_gor_dv","bk_race",
                         ## economic stauts
                         "bk_jbstat",
                         ## weight
                         "bk_xrwght","bk_lrwght"),
