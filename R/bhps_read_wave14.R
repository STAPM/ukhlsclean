#' Read British Household Panel Survey Wave 14
#'
#' Reads and does basic cleaning on the BHPS 14th wave.
#'
#' MISSING VALUES
#'
#' \itemize{
...
#' }
#' @export
bhps_read_wave14 <- function(
  root = c("C:/"),
  path = "Users/User/Documents/Datasets/UKHLS/tab/"
) {

  print("Reading BHPS Wave 14")
  data <- data.table::fread(
    paste0(root[1], path, "bhps_w14/bn_indresp.tab"),
  ...
  demographic_vars <- colnames(data[ , c(33,1054,32,1251,157)])
  econ_stat_vars   <- colnames(data[,c(38)])
  weight_vars      <- colnames(data[,c(1168,1166)])
  ...
  data.table::setnames(data,
                       c("pid","bn_hidp","bn_pno",
                         ## demographic
                         "bn_sex","bn_age_dv","bn_doby","bn_gor_dv","bn_racel_bh",
                         ## economic stauts
                         "bn_jbstat",
                         ## weight
                         "bn_xrwght","bn_lrwght"),
