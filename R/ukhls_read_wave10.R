...
#'
#' Reads and does basic cleaning on the UKHLS tenth wave.
#'
#' MISSING VALUES
#'
#' \itemize{
...
ukhls_read_wave10 <- function(
  ...
  cat(crayon::magenta("\tReading UKHLS Wave 10"))
  ...
  data <- data.table::fread(
    paste0(path, "/ukhls_w10/j_indresp.tab"),
    showProgress = FALSE,
  ...
  data.hhold <- data.table::fread(
    paste0(path, "/ukhls_w10/j_hhresp.tab"),
    showProgress = FALSE,
